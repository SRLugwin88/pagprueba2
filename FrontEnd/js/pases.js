document.addEventListener('DOMContentLoaded', async () => {
  ...
  function abrirModalEditarPase(pase) {
    ...
    modal.querySelector('#form-editar-pase').onsubmit = async function(e) {
      ...
      if (hayError) return;
      try {
        const res = await fetch(`https://pagprueba2-production-b22b.up.railway.app/pase/updatePase/${pase.id_pase}`, {
          method: 'PUT',
          headers: {
  ...
  async function cargarPasesGlobal() {
    ...
    try {
      const url = 'https://pagprueba2-production-b22b.up.railway.app/pase/getPases';
  ...
  async function cargarDepartamentos() {
    try {
      ...
      departamentos = await fetchData('https://pagprueba2-production-b22b.up.railway.app/departamento/getdepartamentos', {
  ...
  async function cargarEmpleados() {
    empleados = await fetchData('https://pagprueba2-production-b22b.up.railway.app/empleado/getempleados', {
      'Authorization': `Bearer ${localStorage.getItem('token')}`
    });
    if (selectReceptor) {
      selectReceptor.innerHTML = '<option value="">Seleccione un empleado</option>';
  ...
  async function cargarDocumentos() {
    const documentos = await fetchData('https://pagprueba2-production-b22b.up.railway.app/documento/getdocumentos', {
      'Authorization': `Bearer ${localStorage.getItem('token')}`
    });
    if (selectDocumento) {
  ...
  async function crearPase(event) {
    ...
    try {app
      const res = await fetch('https://pagprueba2-production-b22b.up.railway.app/pase/createPase', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`
